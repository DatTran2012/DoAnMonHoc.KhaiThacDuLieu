...
namespace KTDL
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\DoAnKTDL\Train.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.OneVersusAll(mlContext.BinaryClassification.Trainers.LinearSvm(labelColumnName: @"class", numberOfIterations: 10, featureColumnName: "Features"), labelColumnName: @"class")
